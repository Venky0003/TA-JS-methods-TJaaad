...
*/
let word = "is";
let indexOfIs = quote.indexOf(word)
console.log(indexOfIs);
/*
2. Find the character at the index indexOfIs (Problem 1) in quote.
*/
console.log(`The cahracter at index  "${word}" is  ${indexOfIs}`)
/*
...
*/
  quoteSplitted[11]="tomorrow";
  console.log(quoteSplitted.join(" "));
/*
12. Find the index of second "o" in quote. Use indexOf
*/
let wordO = "o"
let second = quote.indexOf(wordO)
console.log(`The index of second "${wordO}" is ${quote.indexOf(wordO,(second+1))}`)
/*
...
*/
console.log(quote.slice(30).padEnd(30,"."))
/*
